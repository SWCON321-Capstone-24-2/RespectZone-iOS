...
final class BaseService: BaseServiceProtocol {
    ...
    func postSentence(id: Int, requestBody: PostSentenceRequestDTO) async throws -> PostSentenceResponseDTO {
        ...
        return decodeResult.result ?? PostSentenceResponseDTO(speechId: 0, sentence: "", sentenceType: "", message: "", predScore: 0.0, scores: Scores(gender: 0.0, age: 0.0, other: 0.0, swear: 0.0, clean: 0.0))
    }
